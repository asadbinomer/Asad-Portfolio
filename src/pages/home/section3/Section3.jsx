  ...
  return (
    <>
      <div className="w-full flex items-center justify-center">
        <div className="w-full max-w-[1200px] flex flex-col items-start gap-[60px] max-[450px]:flex-col max-[450px]:px-[15px] max-[450px]:py-[20px] max-[450px]:gap-[50px] max-[640px]:items-start max-[640px]:px-[50px] max-[640px]:py-[20px] max-[640px]:gap-[50px] max-[640px]:flex-col max-[768px]:px-[100px] max-[768px]:py-[20px]">
          <div className="w-[100%] p-[40px] flex items-center gap-[40px] justify-between bg-[#121314] border-[#222628] border-[2px] rounded-[16px] max-[450px]::flex-col max-[450px]::text-center max-[640px]:flex-col max-[640px]:text-center">
            ...
            <div className="flex flex-col gap-[10px]">
              <h4 className="text-[25px] font-semibold">
                Visual Designer & Webflow Developer.
              </h4>
              <p className="text-[14.3px] font-semibold text-[#7B848B]">
                I specialize in UI/UX & Graphic Design and my passion is all
                about <br /> building elegant and professional user interfaces
                and websites. I also <br /> do branding nd identity design such
                as logo design, and business <br /> cards, along with photo
                editing.
              </p>
            </div>
            <div className="flex flex-col gap-[16px]">
              <UButton
                ...
                primary={true}
                className="text-[#fff] leading-6"
                iconEnd={<i className="ri-arrow-right-line text-[22px]"></i>}
              />
              <UButton
            ...
            <div className="flex flex-col gap-[36px]">
              ...
              <div className="flex flex-col gap-[10px]">
                <div className="flex flex-col gap-[5px]">
                  <p className="text-[14px] font-semibold text-[#1777e5]">
                    2021 - Present • UK
                  </p>
                ...
                <p className="text-[14px] font-medium text-[#5E6971]">
                  Bachelor's Degree in Computer Science ABC <br /> Technical
              ...
              <div className="flex flex-col gap-[10px]">
                <div className="flex flex-col gap-[5px]">
                  <p className="text-[14px] font-semibold text-[#1777e5]">
                    2016 - 2019 • Cambridge University
                  </p>
                  <h4 className="text-[20px] font-semibold">
                ...
                <p className="text-[14px] font-medium text-[#5E6971]">
                  Coursework - Git, WordPress, Javascript, iOS, <br /> Android,
                  appleos and macos.
                </p>
              </div>
              <div className="flex flex-col gap-[10px]">
            ...
            <div className="flex flex-col gap-[36px]">
              ...
              <div className="flex flex-col gap-[10px]">
                <div className="flex flex-col gap-[5px]">
                  ...
                  <h4 className="text-[20px] font-semibold">
                    Team Lead of UI/UX Designer
                  </h4>
                </div>
                <p className="text-[14px] font-medium text-[#5E6971]">
                  Collaborate with creative and development <br /> teams on the
                  execution of ideas.
                </p>
              </div>
              <div className="flex flex-col gap-[10px]">
                ...
                <p className="text-[14px] font-medium text-[#5E6971]">
                  Monitored technical aspects of the front-end <br /> delivery
                  for projects.
                </p>
              </div>
              <div className="flex flex-col gap-[10px]">
                ...
                <p className="text-[14px] font-medium text-[#5E6971]">
                  Optimize your website and apps performance <br /> using latest
                  technology.
                </p>
              </div>
            </div>

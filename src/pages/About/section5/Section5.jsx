          ...
          <div className="flex items-center gap-[24px] justify-between max-[640px]:flex-wrap">
            <div className="flex flex-col gap-[32px] rounded-[10px] overflow-hidden w-[100%] max-[450px]:w-[100%] max-[640px]:w-[200px]">
              ...
              <div className="flex flex-col gap-[12px]">
                <h4 className="text-[22px] font-semibold max-[375px]:text-[18px] max-[640px]:text-[20px]">
                  Drawing (2016 - 2022)
                </h4>
                <p className="text-[16px] font-medium text-[#5E6971]">
                  Aliquam hendrerit quis nisl eget varius. Duis viverra vel quam
                  sed posuere. Praesent tempor cursus semeu.
                </p>
              </div>
            </div>
            <div className="flex flex-col gap-[32px] rounded-[10px] overflow-hidden w-[100%] max-[450px]:w-[100%] max-[640px]:w-[200px]">
              ...
              <div className="flex flex-col gap-[12px]">
                ...
                <p className="text-[16px] font-medium text-[#5E6971]">
                  Etiam cursus dolor vel ipsum vulputate tincidunt. Nunc metus
                  nisl, posuere nec cursus a, faucibus in elit.{" "}
                </p>
              </div>
            </div>
            <div className="flex flex-col gap-[32px] rounded-[10px] overflow-hidden w-[100%] max-[450px]:w-[100%] max-[640px]:w-[200px]">
              ...
              <div className="flex flex-col gap-[12px]">
                ...
                <p className="text-[16px] font-medium text-[#5E6971]">
                  Pellentesque ullamcorper risus nec condimentum fermentum.
                  Nullam vitae efficitur ex.
                </p>
              </div>
            </div>
          </div>

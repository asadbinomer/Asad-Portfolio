...
function Section3() {
  return (
    <>
    <div className="px-[180px] py-[100px] w-[100%] flex flex-col items-start gap-[60px] max-[450px]:flex-col max-[450px]:px-[15px] max-[450px]:py-[20px] max-[450px]:gap-[50px] max-[640px]:items-start max-[640px]:px-[50px] max-[640px]:py-[20px] max-[640px]:gap-[50px] max-[640px]:flex-col max-[768px]:px-[100px] max-[768px]:py-[20px] ">
      <div className="flex gap-[50px] justify-between max-[450px]::flex-col max-[640px]:flex-col">
        ...
        <div className="flex flex-col gap-[36px]">
          <div className="flex items-center gap-[24px]">
            ...
            <p className='text-[18px] font-semibold text-[#FF5F49]'>Work History</p>
          </div>
          <div className="flex flex-col gap-[10px]">
            <div className="flex flex-col gap-[5px]">
              <p className='text-[14px] font-semibold text-[#FF5F49]'>2021 - Present • UK</p>
          ...
          <div className="flex flex-col gap-[10px]">
            <div className="flex flex-col gap-[5px]">
              <p className='text-[14px] font-semibold text-[#FF5F49]'>2016 - 2019 • Apple</p>
          ...
          <div className="flex flex-col gap-[10px]">
            <div className="flex flex-col gap-[5px]">
              <p className='text-[14px] font-semibold text-[#FF5F49]'>2010 - 2014 • Nasa</p>
        ...
        <div className="flex flex-col gap-[36px] w-[350px] max-[640px]:w-[100%]">
          <div className="flex items-center gap-[24px]">
            <div className="w-[30px] h-[2px] bg-[#FF5F49]"></div>
            <p className='text-[18px] font-semibold text-[#FF5F49]'>Tools i USE</p>
          </div>
